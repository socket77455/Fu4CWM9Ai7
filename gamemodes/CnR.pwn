...
{
	print("\n-----------------------------------");
	print("NGCNR (v2.17) PinEvil Loaded");
	print("------------------------------------\n");
}
...
public OnGameModeInit()
{
	...
	connection = mysql_init(LOG_ONLY_ERRORS, 1);
 	...
 	mysql_connect("127.0.0.1", "port_9890", "xu18r7kzcp", "port_9890", connection, 1);
	...
	// Registered Player Textdraws
	Textdrawn0 = TextDrawCreate(158.000000, 137.812500, "WELCOME TO NEXUS GAMMERS");
	...
	Textdraw10 = TextDrawCreate(215.000000, 434.000000, "www.nexuscnr.boards.net");
	...
	Textdraw15 = TextDrawCreate(122.500000, 338.187500, "NEXUS GAMERS");
...
public OnPlayerConnect(playerid)
{
	...
	SendClientMessage(playerid, -1, "{A9C4E4}Welcome To Nexus Gamers {4545F2}Cops {FFFFFF}And {F81414}Robbers, {CCCC00}Version: {00FF22}v1.2.17");
	SendClientMessage(playerid, -1, "{EE5555}WARNING: {A9C4E4}The content and concept on this server is explicit as with GTA SA.!");
	SendClientMessage(playerid, -1, "{CCCC00}Visit Our server Website {F81414}www.nexuscnr.boards.net{CCCC00} and forum For more {00FF22}information{CCCC00} about server..");
	SendClientMessage(playerid, -1, "{EE5555}___________________________________________________________________________________");
...
public check_vip(index, response_code, data[])
{
    if(response_code == 200)
    {
		...
		switch(redeem)
		{
		    ...
		    {
				format(string, sizeof(string), "%s{98B0CD}NGCNR Code Redemption Service\n\n", string);
				...
				format(string, sizeof(string), "%s{58D3F7}www.nexuscnr.boards.net", string);
